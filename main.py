#!/usr/bin/env python3
"""
CSS Refactoring Tool - Main Entry Point
"""
...
def main():
    """Main entry point for the CSS refactoring tool"""
    parser = argparse.ArgumentParser(
        description="AI-powered CSS refactoring tool",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  %(prog)s start                    # Start refactoring in current directory
  %(prog)s start /path/to/project   # Refactor specific directory
  %(prog)s --check-setup            # Verify installation
  %(prog)s start --dry-run          # Preview changes without applying
        """
    )
    ...
    parser.add_argument(
        ...
        help='Ollama model to use (default: qwen2.5-coder:0.5b for speed, try qwen2.5-coder:1.5b for better accuracy)'
    )
